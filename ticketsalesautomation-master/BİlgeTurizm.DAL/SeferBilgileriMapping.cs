   ...
   public class SeferBilgileriMapping : EntityTypeConfiguration<SeferBilgileri>
    {
        public SeferBilgileriMapping()
        {
            ...
            //Property(x => x.Nereden).HasColumnType("nvarchar").IsRequired().HasMaxLength(20);
            //Property(x => x.Nereye).HasColumnType("nvarchar").IsRequired().HasMaxLength(20);
            ...
            //HasRequired(x => x.SehirlerinSeferi).WithRequiredPrincipal(x => x.SeferSehirleri);
